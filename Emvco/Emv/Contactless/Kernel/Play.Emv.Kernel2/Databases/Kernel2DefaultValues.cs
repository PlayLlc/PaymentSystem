...
public class Kernel2DefaultValues : DefaultValues
{
    ...
    private static PrimitiveValue[] GetKernel2Defaults()
    {
        return new PrimitiveValue[]
        {
            ...
            new HoldTimeValue(new Deciseconds(0x0D)), new KernelConfiguration(0x00), (KernelId) ShortKernelIdTypes.Kernel2,
            new MagstripeApplicationVersionNumberReader(0x01), new MagstripeCvmCapabilityCvmRequired(0xF0),
            new MagstripeCvmCapabilityNoCvmRequired(0xF0),
            MaxLifetimeOfTornTransactionLogRecords.Decode(new byte[] {0x1, 0x2C}.AsSpan()),
            new MaxNumberOfTornTransactionLogRecords(0x00), new MessageHoldTime(0x13), new MaximumRelayResistanceGracePeriod(0x32),
            new MinimumRelayResistanceGracePeriod(0x14), new ReaderContactlessFloorLimit(0x00),
            ...
            new TimeoutValue(new Milliseconds(0x01F4)), new TransactionType(0x00)
        };
    }
