...
{ AdditionalTerminalCapabilities.Tag, new KnownObjects(AdditionalTerminalCapabilities.Tag, AdditionalTerminalCapabilities.Decode) },
...
{ ApplicationCapabilitiesInformation.Tag, new KnownObjects(ApplicationCapabilitiesInformation.Tag, ApplicationCapabilitiesInformation.Decode) },
...
{ ApplicationInterchangeProfile.Tag, new KnownObjects(ApplicationInterchangeProfile.Tag, ApplicationInterchangeProfile.Decode) },
...
{ ApplicationTransactionCounter.Tag, new KnownObjects(ApplicationTransactionCounter.Tag, ApplicationTransactionCounter.Decode) },
...
{ ApplicationVersionNumberReader.Tag, new KnownObjects(ApplicationVersionNumberReader.Tag, ApplicationVersionNumberReader.Decode) },
...
{ CardRiskManagementDataObjectList1.Tag, new KnownObjects(CardRiskManagementDataObjectList1.Tag, CardRiskManagementDataObjectList1.Decode) },
{ CardRiskManagementDataObjectList1RelatedData.Tag, new KnownObjects(CardRiskManagementDataObjectList1RelatedData.Tag, CardRiskManagementDataObjectList1RelatedData.Decode) },
{ CryptogramInformationData.Tag, new KnownObjects(CryptogramInformationData.Tag, CryptogramInformationData.Decode) },
{ CardholderVerificationCode3Track1.Tag, new KnownObjects(CardholderVerificationCode3Track1.Tag, CardholderVerificationCode3Track1.Decode) },
{ CardholderVerificationCode3Track2.Tag, new KnownObjects(CardholderVerificationCode3Track2.Tag, CardholderVerificationCode3Track2.Decode) },
...
{ DataRecoveryDataObjectListRelatedData.Tag, new KnownObjects(DataRecoveryDataObjectListRelatedData.Tag, DataRecoveryDataObjectListRelatedData.Decode) },
{ DataStorageApplicationCryptogramType.Tag, new KnownObjects(DataStorageApplicationCryptogramType.Tag, DataStorageApplicationCryptogramType.Decode) },
...
{ DataStorageOperatorDataSetCard.Tag, new KnownObjects(DataStorageOperatorDataSetCard.Tag, DataStorageOperatorDataSetCard.Decode) },
{ DataStorageOperatorDataSetInfo.Tag, new KnownObjects(DataStorageOperatorDataSetInfo.Tag, DataStorageOperatorDataSetInfo.Decode) },
{ DataStorageOperatorDataSetInfoForReader.Tag, new KnownObjects(DataStorageOperatorDataSetInfoForReader.Tag, DataStorageOperatorDataSetInfoForReader.Decode) },
{ DataStorageOperatorDataSetTerminal.Tag, new KnownObjects(DataStorageOperatorDataSetTerminal.Tag, DataStorageOperatorDataSetTerminal.Decode) },
{ DataStorageRequestedOperatorId.Tag, new KnownObjects(DataStorageRequestedOperatorId.Tag, DataStorageRequestedOperatorId.Decode) },
{ DataStorageSlotManagementControl.Tag, new KnownObjects(DataStorageSlotManagementControl.Tag, DataStorageSlotManagementControl.Decode) },
...
{ DataStorageUnpredictableNumber.Tag, new KnownObjects(DataStorageUnpredictableNumber.Tag, DataStorageUnpredictableNumber.Decode) },
{ DataStorageVersionNumberTerminal.Tag, new KnownObjects(DataStorageVersionNumberTerminal.Tag, DataStorageVersionNumberTerminal.Decode) },
...
{ DefaultUnpredictableNumberDataObjectList.Tag, new KnownObjects(DefaultUnpredictableNumberDataObjectList.Tag, DefaultUnpredictableNumberDataObjectList.Decode) },
{ DeviceEstimatedTransmissionTimeForRelayResistanceRapdu.Tag, new KnownObjects(DeviceEstimatedTransmissionTimeForRelayResistanceRapdu.Tag, DeviceEstimatedTransmissionTimeForRelayResistanceRapdu.Decode) },
...
{ MagstripeApplicationVersionNumberReader.Tag, new KnownObjects(MagstripeApplicationVersionNumberReader.Tag, MagstripeApplicationVersionNumberReader.Decode) },
{ MagstripeCvmCapabilityCvmRequired.Tag, new KnownObjects(MagstripeCvmCapabilityCvmRequired.Tag, MagstripeCvmCapabilityCvmRequired.Decode) },
{ MagstripeCvmCapabilityNoCvmRequired.Tag, new KnownObjects(MagstripeCvmCapabilityNoCvmRequired.Tag, MagstripeCvmCapabilityNoCvmRequired.Decode) },
{ MaximumRelayResistanceGracePeriod.Tag, new KnownObjects(MaximumRelayResistanceGracePeriod.Tag, MaximumRelayResistanceGracePeriod.Decode) },
{ MaxLifetimeOfTornTransactionLogRecords.Tag, new KnownObjects(MaxLifetimeOfTornTransactionLogRecords.Tag, MaxLifetimeOfTornTransactionLogRecords.Decode) },
{ MaxNumberOfTornTransactionLogRecords.Tag, new KnownObjects(MaxNumberOfTornTransactionLogRecords.Tag, MaxNumberOfTornTransactionLogRecords.Decode) },
{ MaxTimeForProcessingRelayResistanceApdu.Tag, new KnownObjects(MaxTimeForProcessingRelayResistanceApdu.Tag, MaxTimeForProcessingRelayResistanceApdu.Decode) },
{ MeasuredRelayResistanceProcessingTime.Tag, new KnownObjects(MeasuredRelayResistanceProcessingTime.Tag, MeasuredRelayResistanceProcessingTime.Decode) },
...
{ MinimumRelayResistanceGracePeriod.Tag, new KnownObjects(MinimumRelayResistanceGracePeriod.Tag, MinimumRelayResistanceGracePeriod.Decode) },
{ MinTimeForProcessingRelayResistanceApdu.Tag, new KnownObjects(MinTimeForProcessingRelayResistanceApdu.Tag, MinTimeForProcessingRelayResistanceApdu.Decode) },
{ MobileSupportIndicator.Tag, new KnownObjects(MobileSupportIndicator.Tag, MobileSupportIndicator.Decode) },
{ NumericApplicationTransactionCounterTrack1.Tag, new KnownObjects(NumericApplicationTransactionCounterTrack1.Tag, NumericApplicationTransactionCounterTrack1.Decode) },
{ NumericApplicationTransactionCounterTrack2.Tag, new KnownObjects(NumericApplicationTransactionCounterTrack2.Tag, NumericApplicationTransactionCounterTrack2.Decode) },
...
{ PosCardholderInteractionInformation.Tag, new KnownObjects(PosCardholderInteractionInformation.Tag, PosCardholderInteractionInformation.Decode) },
{ PositionOfCardVerificationCode3Track1.Tag, new KnownObjects(PositionOfCardVerificationCode3Track1.Tag, PositionOfCardVerificationCode3Track1.Decode) },
{ PositionOfCardVerificationCode3Track2.Tag, new KnownObjects(PositionOfCardVerificationCode3Track2.Tag, PositionOfCardVerificationCode3Track2.Decode) },
...
{ ProcessingOptionsDataObjectList.Tag, new KnownObjects(ProcessingOptionsDataObjectList.Tag, ProcessingOptionsDataObjectList.Decode) },
{ ProcessingOptionsDataObjectListRelatedData.Tag, new KnownObjects(ProcessingOptionsDataObjectListRelatedData.Tag, ProcessingOptionsDataObjectListRelatedData.Decode) },
...
{ ReaderContactlessTransactionLimitWhenCvmIsNotOnDevice.Tag, new KnownObjects(ReaderContactlessTransactionLimitWhenCvmIsNotOnDevice.Tag, ReaderContactlessTransactionLimitWhenCvmIsNotOnDevice.Decode) },
{ ReaderContactlessTransactionLimitWhenCvmIsOnDevice.Tag, new KnownObjects(ReaderContactlessTransactionLimitWhenCvmIsOnDevice.Tag, ReaderContactlessTransactionLimitWhenCvmIsOnDevice.Decode) },
...
{ RelayResistanceAccuracyThreshold.Tag, new KnownObjects(RelayResistanceAccuracyThreshold.Tag, RelayResistanceAccuracyThreshold.Decode) },
{ RelayResistanceProtocolCounter.Tag, new KnownObjects(RelayResistanceProtocolCounter.Tag, RelayResistanceProtocolCounter.Decode) },
{ RelayResistanceTransmissionTimeMismatchThreshold.Tag, new KnownObjects(RelayResistanceTransmissionTimeMismatchThreshold.Tag, RelayResistanceTransmissionTimeMismatchThreshold.Decode) },
{ ResponseMessageTemplateFormat1.Tag, new KnownObjects(ResponseMessageTemplateFormat1.Tag, ResponseMessageTemplateFormat1.Decode) }, 
...
{ StaticDataAuthenticationTagList.Tag, new KnownObjects(StaticDataAuthenticationTagList.Tag, StaticDataAuthenticationTagList.Decode) },
...
{ TerminalExpectedTransmissionTimeForRelayResistanceCapdu.Tag, new KnownObjects(TerminalExpectedTransmissionTimeForRelayResistanceCapdu.Tag, TerminalExpectedTransmissionTimeForRelayResistanceCapdu.Decode) },
{ TerminalExpectedTransmissionTimeForRelayResistanceRapdu.Tag, new KnownObjects(TerminalExpectedTransmissionTimeForRelayResistanceRapdu.Tag, TerminalExpectedTransmissionTimeForRelayResistanceRapdu.Decode) },
{ TerminalIdentification.Tag, new KnownObjects(TerminalIdentification.Tag, TerminalIdentification.Decode) },
{ TerminalRelayResistanceEntropy.Tag, new KnownObjects(TerminalRelayResistanceEntropy.Tag, TerminalRelayResistanceEntropy.Decode) },
...
{ UnpredictableNumberDataObjectList.Tag, new KnownObjects(UnpredictableNumberDataObjectList.Tag, UnpredictableNumberDataObjectList.Decode) },
