...
public class WaitingForGetDataResponse : KernelState
{
    ...
    public static readonly KernelStateId KernelStateId = new(nameof(WaitingForGetDataResponse));

    #endregion

    #region Constructor

    public WaitingForGetDataResponse(KernelDatabase kernelDatabase, DataExchangeKernelService dataExchange) :
