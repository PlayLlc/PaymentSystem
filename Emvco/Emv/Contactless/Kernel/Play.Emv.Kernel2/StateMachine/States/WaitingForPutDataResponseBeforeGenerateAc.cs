...
public class WaitingForPutDataResponseBeforeGenerateAc : KernelState
{
    ...
    public static readonly KernelStateId KernelStateId = new(nameof(WaitingForPutDataResponseBeforeGenerateAc));

    #endregion

    public override KernelStateId GetKernelStateId() => throw new NotImplementedException();
