...
public class WaitingForGenerateAcResponse1 : KernelState
{
    ...
    public static readonly KernelStateId KernelStateId = new(nameof(WaitingForGenerateAcResponse1));

    #endregion

    #region Constructor

    public WaitingForGenerateAcResponse1(KernelDatabase kernelDatabase, DataExchangeKernelService dataExchange) : base(kernelDatabase,
        dataExchange)
    { }
