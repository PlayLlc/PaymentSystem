...
public class WaitingForGenerateAcResponse2 : KernelState
{
    ...
    public static readonly KernelStateId KernelStateId = new(nameof(WaitingForGenerateAcResponse2));

    #endregion

    #region Constructor

    public WaitingForGenerateAcResponse2(KernelDatabase kernelDatabase, DataExchangeKernelService dataExchange) :
