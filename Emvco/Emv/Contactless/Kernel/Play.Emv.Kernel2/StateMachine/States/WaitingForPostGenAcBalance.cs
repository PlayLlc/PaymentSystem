...
public class WaitingForPostGenAcBalance : KernelState
{
    ...
    public static readonly StateId StateId = new(nameof(WaitingForPostGenAcBalance));

    #endregion

    #region Constructor

    public WaitingForPostGenAcBalance(KernelDatabase kernelDatabase, DataExchangeKernelService dataExchange, IKernelEndpoint kernelEndpoint)
