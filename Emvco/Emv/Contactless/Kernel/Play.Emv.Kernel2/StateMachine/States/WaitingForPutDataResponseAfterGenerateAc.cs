...
public class WaitingForPutDataResponseAfterGenerateAc : KernelState
{
    ...
    public static readonly KernelStateId KernelStateId = new(nameof(WaitingForPutDataResponseAfterGenerateAc));

    #endregion

    #region Constructor

    public WaitingForPutDataResponseAfterGenerateAc(KernelDatabase kernelDatabase, DataExchangeKernelService dataExchange) :
