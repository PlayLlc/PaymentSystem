...
/// </remarks>
public class AlphabeticInterchangeDataFieldCodec : AlphabeticEmvCodec, IInterchangeDataFieldCodec
{
    #region Static Metadata

    public static readonly InterchangeEncodingId Identifier =
        IInterchangeDataFieldCodec.GetEncodingId(typeof(AlphabeticInterchangeDataFieldCodec));
