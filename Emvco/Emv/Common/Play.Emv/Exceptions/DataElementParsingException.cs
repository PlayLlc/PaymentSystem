...
public class DataElementParsingException : BerParsingException
{
    ...
    public DataElementParsingException(
        ...
        [CallerMemberName] string memberName = "",
        [CallerLineNumber] int lineNumber = 0) :
        base($"{TraceExceptionMessage(typeof(DataElementParsingException), fileName, memberName, lineNumber)} {message}")
    { }
    ...
    public DataElementParsingException(
        ...
        [CallerMemberName] string memberName = "",
        [CallerLineNumber] int lineNumber = 0) :
        base($"{TraceExceptionMessage(typeof(DataElementParsingException), fileName, memberName, lineNumber)} {message}", innerException)
    { }
