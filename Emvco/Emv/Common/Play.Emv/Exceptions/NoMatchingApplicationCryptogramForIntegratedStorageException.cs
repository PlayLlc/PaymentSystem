...
namespace Play.Emv.Exceptions
{
    ...
    public class NoMatchingApplicationCryptogramForIntegratedStorageException : CodecParsingException
    {
        ...
        public NoMatchingApplicationCryptogramForIntegratedStorageException(
            ...
            [CallerMemberName] string memberName = "",
            [CallerLineNumber] int lineNumber = 0) : base(
            $"{TraceExceptionMessage(typeof(NoMatchingApplicationCryptogramForIntegratedStorageException), fileName, memberName, lineNumber)}", innerException)
        { }
        ...
        public NoMatchingApplicationCryptogramForIntegratedStorageException(
            ...
            [CallerMemberName] string memberName = "",
            [CallerLineNumber] int lineNumber = 0) : base(
            $"{TraceExceptionMessage(typeof(NoMatchingApplicationCryptogramForIntegratedStorageException), fileName, memberName, lineNumber)} {message}", innerException)
        { }
