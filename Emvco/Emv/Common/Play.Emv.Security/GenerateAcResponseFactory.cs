    ...
    public override GenerateAcResponseMessage Create(RApduSignal value)
    {
        ...
        CryptogramInformationData cryptogramInformationData =
            ...
            ?? throw new InvalidOperationException(
                $"A problem occurred while decoding {nameof(GenerateAcResponseMessage)}. A {nameof(CryptogramInformationData)} was expected but could not be found");
        ...
        ApplicationTransactionCounter applicationTransactionCounter =
            ...
            ?? throw new InvalidOperationException(
                $"A problem occurred while decoding {nameof(GenerateAcResponseMessage)}. A {nameof(ApplicationTransactionCounter)} was expected but could not be found");

        ApplicationCryptogram applicationCryptogram =
            _Codec.AsPrimitive(ApplicationCryptogram.Decode, ApplicationCryptogram.Tag, encodedTlvSiblings)
            ?? throw new InvalidOperationException(
                $"A problem occurred while decoding {nameof(GenerateAcResponseMessage)}. A {nameof(ApplicationCryptogram)} was expected but could not be found");
