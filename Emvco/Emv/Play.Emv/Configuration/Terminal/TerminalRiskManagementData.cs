...
/// </summary>
public record TerminalRiskManagementData : PrimitiveValue, IEqualityComparer<TerminalRiskManagementData>
{
    ...
    public TerminalRiskManagementData(ulong value)
    {
        _Value = value;
    }
    ...
    public static TerminalRiskManagementData Decode(ReadOnlyMemory<byte> value, BerCodec codec) => Decode(value.Span, codec);

    /// <exception cref="InvalidOperationException"></exception>
    /// <exception cref="BerException"></exception>
    public static TerminalRiskManagementData Decode(ReadOnlySpan<byte> value, BerCodec codec)
    {
        ...
        if (value.Length != byteLength)
        {
            throw new ArgumentOutOfRangeException(
                $"The Primitive Value {nameof(TerminalRiskManagementData)} could not be initialized because the byte length provided was out of range. The byte length was {value.Length} but must be {byteLength} bytes in length");
        }
