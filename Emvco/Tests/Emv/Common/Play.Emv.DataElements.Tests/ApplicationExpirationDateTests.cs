...
public class ApplicationExpirationDateTests
{
    ...
    public void BerEncoding_DeserializingDataElement_CreatesPrimitiveValue()
    {
        ...
        ApplicationExpirationDate testValue = ApplicationExpirationDate.Decode(testData.EncodeValue().AsSpan());
    ...
    {
        ApplicationExpirationDateTestTlv testData = new();
        ApplicationExpirationDate sut = ApplicationExpirationDate.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(ApplicationExpirationDate.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
