...
public partial class Randomize
{
    public class Ascii
    {
        ...
        private static readonly ImmutableSortedDictionary<char, byte> _ByteMap =
            Enumerable.Range(0, 127).ToImmutableSortedDictionary(a => (char) a, b => (byte) b);

        private static readonly ImmutableSortedDictionary<byte, char> _CharMap =
            Enumerable.Range(0, 127).ToImmutableSortedDictionary(a => (byte) a, b => (char) b);
        ...
        public static byte GetRandomByte() => (byte) _ByteMap[GetRandomChar()];
