...
public class BerConfiguration
{
    ...
    // TODO: There is no reason to map the PrimitiveValues or to keep that map in memory. As long as
    // TODO: there is a map of the BerPrimitiveCodec objects with their identifier being the key, we
    // TODO: can resolve the correct type. If there is a PrimitiveValue that is unresolvable to a
    // TODO: BerPrimitiveCodec, then we can return an UnknownPrimitiveValue that is padded with 0x00
    // TODO: according to the Length specification of the TLV
}