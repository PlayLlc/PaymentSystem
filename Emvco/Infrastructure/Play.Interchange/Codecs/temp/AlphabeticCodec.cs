...
public class AlphabeticInterchangeCodec : InterchangeDataFieldCodec
{
    #region Static Metadata

    private static readonly Alphabetic _Alphabetic = PlayEncoding.Alphabetic;
    public static readonly InterchangeEncodingId Identifier = GetEncodingId(typeof(AlphabeticCodec));
