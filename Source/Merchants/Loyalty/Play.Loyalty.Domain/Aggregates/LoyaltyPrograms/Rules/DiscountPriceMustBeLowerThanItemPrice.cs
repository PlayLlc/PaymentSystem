...
public class DiscountPriceMustBeLowerThanItemPrice : BusinessRule<LoyaltyProgram, SimpleStringId>
{
    ...
    public override DiscountedPriceIsTooHigh CreateBusinessRuleViolationDomainEvent(LoyaltyProgram aggregate) => new(aggregate, this);
