...
{
    public class DiscountsProgram : Entity<SimpleStringId>
    {
        ...
        private DiscountsProgram()
        { }

        /// <exception cref="ValueObjectException"></exception>
        internal DiscountsProgram(DiscountsProgramDto dto)
        {
        ...
        /// <exception cref="ValueObjectException"></exception>
        internal DiscountsProgram(string id, bool isActive, IEnumerable<Discount> discounts)
        {
        ...
        public bool DoesDiscountExist(string discountId) => _Discounts.Any(a => a.Id == discountId);
        public bool DoesDiscountExist(string itemId, string variationId) => _Discounts.Any(a => a.IsDiscountedItem(itemId, variationId));
