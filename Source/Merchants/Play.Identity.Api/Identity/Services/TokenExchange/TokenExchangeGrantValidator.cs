namespace Play.Identity.Api.Identity.Services.TokenExchange;
...
//            context.Result = new GrantValidationResult(sub, GrantType, customResponse: customResponse);
//        }
...
//            context.Result = new GrantValidationResult(sub, GrantType, new[] {actClaim}, customResponse: customResponse);
//        }
