...
public class InventoryDbSeeder
{
    ...
    private readonly IRetrieveUsers _UserService;
    private readonly IRetrieveMerchants _MerchantService;

    #endregion

    #region Constructor

    public InventoryDbSeeder(IRetrieveUsers userService, IRetrieveMerchants merchantService, IItemRepository itemRepository)
    {
