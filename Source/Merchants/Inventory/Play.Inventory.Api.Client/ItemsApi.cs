...
namespace IO.Swagger
{
    ...
    public interface IItemsApi : IApiAccessor
    {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        Task<ApiResponse<object>> ItemsItemIdVariationsVariationIdNamePutAsyncWithHttpInfo(
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        Task<ApiResponse<object>> ItemsItemIdVariationsVariationIdSkuPutAsyncWithHttpInfo(
