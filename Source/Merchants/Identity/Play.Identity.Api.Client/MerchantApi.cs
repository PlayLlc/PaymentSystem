...
namespace Play.Identity.Api.Client
{
    ...
    public partial class MerchantApi : IMerchantApi
    {
        ...
        /// <returns></returns>
        public void ApprovePost(UpdateMerchantRegistrationCommand body = null)
        {
            ApprovePostWithHttpInfo(body);
        }
        ...
        public ApiResponse<object> ApprovePostWithHttpInfo(UpdateMerchantRegistrationCommand body = null)
        {
        ...
        public async Task ApprovePostAsync(UpdateMerchantRegistrationCommand body = null)
        {
            await ApprovePostAsyncWithHttpInfo(body);
        }
        ...
        public async Task<ApiResponse<object>> ApprovePostAsyncWithHttpInfo(UpdateMerchantRegistrationCommand body = null)
        {
            var localVarPath = "./Registration/Merchant/Approve";
            var localVarPathParams = new Dictionary<string, string>();
            var localVarQueryParams = new List<KeyValuePair<string, string>>();
        ...
        public MerchantRegistrationDto Get(string id = null)
        {
            ApiResponse<MerchantRegistrationDto> localVarResponse = GetWithHttpInfo(id);
        ...
        public ApiResponse<MerchantRegistrationDto> GetWithHttpInfo(string id = null)
        {
        ...
        public async Task<MerchantRegistrationDto> GetAsync(string id = null)
        {
            ApiResponse<MerchantRegistrationDto> localVarResponse = await GetAsyncWithHttpInfo(id);
        ...
        public async Task<ApiResponse<MerchantRegistrationDto>> GetAsyncWithHttpInfo(string id = null)
        {
            var localVarPath = "./Registration/Merchant";
            var localVarPathParams = new Dictionary<string, string>();
            var localVarQueryParams = new List<KeyValuePair<string, string>>();
        ...
        /// <param name="body"> (optional)</param>
        /// <returns></returns>
        public void Post(CreateMerchantRegistrationCommand body = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<object> PostWithHttpInfo(CreateMerchantRegistrationCommand body = null)
        {
            var localVarPath = "./Registration/Merchant";
            var localVarPathParams = new Dictionary<string, string>();
            var localVarQueryParams = new List<KeyValuePair<string, string>>();
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of void</returns>
        public async Task PostAsync(CreateMerchantRegistrationCommand body = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<object>> PostAsyncWithHttpInfo(CreateMerchantRegistrationCommand body = null)
        {
            var localVarPath = "./Registration/Merchant";
            var localVarPathParams = new Dictionary<string, string>();
            var localVarQueryParams = new List<KeyValuePair<string, string>>();
