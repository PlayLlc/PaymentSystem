...
namespace Play.Accounts.Application.Handlers.Domain.User
{
    ...
    public class UserRegistrationHandler : DomainEventHandler, IHandleDomainEvents<UserRegistrationRiskAnalysisApproved>,
        IHandleDomainEvents<UserRegistrationCreated>, IHandleDomainEvents<UserRegistrationContactInfoUpdated>,
        IHandleDomainEvents<UserRegistrationPhoneVerified>
    {
        ...
        private readonly IRepository<Accounts.Domain.Aggregates.User, string> _UserRepository;
        ...
        public UserRegistrationHandler(
            ILogger logger, IMessageHandlerContext messageHandlerContext, IVerifyEmailAccounts emailAccountVerifier,
            IRepository<Accounts.Domain.Aggregates.User, string> userRepository, IRepository<UserRegistration, string> userRegistrationRepository,
            IVerifyMobilePhones mobilePhoneVerifier) : base(logger)
        {
