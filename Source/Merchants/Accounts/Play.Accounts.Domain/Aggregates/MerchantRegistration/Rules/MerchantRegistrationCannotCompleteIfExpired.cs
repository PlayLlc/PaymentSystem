...
internal class MerchantRegistrationCannotCompleteIfExpired : BusinessRule<MerchantRegistration, string>
{
    ...
    public MerchantRegistrationCannotCompleteIfExpired(MerchantRegistrationStatus status, DateTimeUtc registeredDate)
    {
