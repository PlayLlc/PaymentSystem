...
namespace Play.Accounts.Api.Services
{
    internal class IdentityService : IIdentityService
    {
        ...
        public async Task<RegisterUserResponse> RegisterUserAsync(RegisterUserRequest value)
        {
            ...
            {
                MerchantId = "",
                UserName = value.ContactInfo.Email,
                Email = value.ContactInfo.Email,
                FirstName = value.ContactInfo.FirstName,
                LastName = value.ContactInfo.LastName,
                PhoneNumber = value.ContactInfo.Phone,
                StreetAddress = value.Address.StreetAddress,
                ApartmentNumber = value.Address.ApartmentNumber,
                City = value.Address.City,
                StateAbbreviation = value.Address.StateAbbreviation,
                Zipcode = value.Address.Zipcode,
                DateOfBirth = value.PersonalInfo.DateOfBirth,
                LastFourOfSocial = value.PersonalInfo.LastFourOfSocial,
