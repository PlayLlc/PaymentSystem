...
internal class MerchantMustNotBeProhibited : BusinessRule<MerchantRegistration>
{
    ...
    public override MerchantIsProhibited CreateBusinessRuleViolationDomainEvent(MerchantRegistration merchant) => new(merchant, this);
