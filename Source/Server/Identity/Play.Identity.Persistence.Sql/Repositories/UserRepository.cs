...
public class UserRepository : IUserRepository
{
    ...
    public async Task UpdateUserRoles(SimpleStringId userId, params UserRole[] roles)
    {
        try
        {
    ...
    /// <exception cref="EntityFrameworkRepositoryException"></exception>
    public async Task<User?> GetByIdAsync(SimpleStringId id)
    {
        try
        {
    ...
    /// <exception cref="EntityFrameworkRepositoryException"></exception>
    public User? GetById(SimpleStringId id)
    {
        try
        {
