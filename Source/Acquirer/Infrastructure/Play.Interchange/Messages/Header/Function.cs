...
public sealed record Function : EnumObject<byte>
{
    ...
    private static readonly Dictionary<byte, Function> _ValueObjectMap = new()
    {
        {Request, Request},
    ...
    public override Function[] GetAll() => _ValueObjectMap.Values.ToArray();

    public override bool TryGet(byte value, out EnumObject<byte>? result)
    {
        if (_ValueObjectMap.TryGetValue(value, out Function? enumResult))
        {
            result = enumResult;
