...
public class SelectApduCommand : ApduCommand
{
    ...
    private SelectApduCommand(Class @class, Instruction instruction, byte parameter1, byte parameter2, ReadOnlySpan<byte> data) : base(@class, instruction,
        parameter1, parameter2, data)
    { }

    private SelectApduCommand(Class @class, Instruction instruction, byte parameter1, byte parameter2) : base(@class, instruction, parameter1, parameter2)
    { }
    ...
    public static SelectApduCommand MasterFile() =>
        new(new Class(SecureMessaging.NotAuthenticated, LogicalChannel.BasicChannel), Instruction.SelectFile, SelectionMode.File, FilePosition.FirstOrOnly,
            FileIdentifier.MasterFile.AsByteArray());
    ...
    public static SelectApduCommand NextDedicatedFileFromCurrentDedicatedFile() =>
        new(new Class(SecureMessaging.NotAuthenticated, LogicalChannel.BasicChannel), Instruction.SelectFile, SelectionMode.DedicatedFileChild,
            FilePosition.Next);
    ...
    public static SelectApduCommand NextElementaryFile() =>
        new(new Class(SecureMessaging.NotAuthenticated, LogicalChannel.BasicChannel), Instruction.SelectFile, SelectionMode.ElementaryFileChild,
            FilePosition.Next);
    ...
    public static SelectApduCommand NextElementaryFile(ShortFileId shortFileIdentifier) =>
        new(new Class(SecureMessaging.NotAuthenticated, LogicalChannel.BasicChannel), Instruction.SelectFile, SelectionMode.ElementaryFileChild,
            FilePosition.FirstOrOnly, new byte[] {shortFileIdentifier});
    ...
    public static SelectApduCommand NextElementaryFileFromCurrentDedicatedFile() =>
        new(new Class(SecureMessaging.NotAuthenticated, LogicalChannel.BasicChannel), Instruction.SelectFile, SelectionMode.ElementaryFileChild,
            FilePosition.FirstOrOnly, FileIdentifier.CurrentDedicatedFile.AsByteArray());
    ...
    {
        return new SelectApduCommand(new Class(SecureMessaging.NotAuthenticated, LogicalChannel.BasicChannel), Instruction.SelectFile, SelectionMode.File,
            FilePosition.FirstOrOnly, new ReadOnlySpan<byte>(new byte[] {0x02}));
    }
    ...
    public static SelectApduCommand ParentDedicatedFileFromCurrentDedicatedFile() =>
        new(new Class(SecureMessaging.NotAuthenticated, LogicalChannel.BasicChannel), Instruction.SelectFile, SelectionMode.DedicatedFileParent,
            FilePosition.FirstOrOnly);
    ...
    public static SelectApduCommand SelectPaymentSystemEnvironment() =>
        new(new Class(SecureMessaging.NotAuthenticated, LogicalChannel.BasicChannel), Instruction.SelectFile, SelectionMode.DedicatedFileName,
            FilePosition.FirstOrOnly, DedicatedFileName.PaymentSystemEnvironment.AsByteArray());
