...
public record Null : PrimitiveValue, IEqualityComparer<Null>
{
    ...
    public override byte[] EncodeTagLengthValue(BerCodec codec, int length) => Array.Empty<byte>();
    public override byte[] EncodeTagLengthValue(BerCodec codec) => Array.Empty<byte>();
