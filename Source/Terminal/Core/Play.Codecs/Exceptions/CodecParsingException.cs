...
public class CodecParsingException : PlayException
{
    ...
    public const string CharacterArrayContainsInvalidValue = "The Character Array contains a value that is out of range of this encoding type.";
    ...
    protected CodecParsingException(string message, Exception innerException) : base(message, innerException)
    { }

    protected CodecParsingException(string message) : base(message)
    { }
    ...
    public CodecParsingException(
        ...
        [CallerLineNumber] int lineNumber = 0) : base($"{TraceExceptionMessage(typeof(CodecParsingException), fileName, memberName, lineNumber)} "
    ...
    public CodecParsingException(
        string message, string value, [CallerFilePath] string fileName = "", [CallerMemberName] string memberName = "", [CallerLineNumber] int lineNumber = 0) :
    ...
    public CodecParsingException(
        ...
        [CallerLineNumber] int lineNumber = 0) : base($"{TraceExceptionMessage(typeof(CodecParsingException), fileName, memberName, lineNumber)} {message}",
        innerException)
    { }
