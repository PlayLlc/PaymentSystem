...
public record ActivateTerminalRequest : RequestSignal
{
    ...
    public ActivateTerminalRequest(
        MessageTypeIndicator messageTypeIndicator, PosEntryMode posEntryMode, string terminalIdentification, byte accountType, ulong amountAuthorized,
        ulong otherAmount, byte transactionType, ulong acquirerIdentifier, string merchantIdentifier) : base(MessageTypeId, ChannelTypeId)
    {
