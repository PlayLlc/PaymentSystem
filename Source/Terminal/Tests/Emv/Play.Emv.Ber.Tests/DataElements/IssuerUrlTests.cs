...
public class IssuerUrlTests
{
    ...
    {
        IssuerUrlTestTlv testData = new();
        IssuerUrl testValue = IssuerUrl.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(IssuerUrl.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
