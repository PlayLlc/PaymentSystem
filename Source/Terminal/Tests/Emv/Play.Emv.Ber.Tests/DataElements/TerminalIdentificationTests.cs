...
public class TerminalIdentificationTests
{
    ...
    {
        TerminalIdentificationTestTlv testData = new();
        TerminalIdentification testValue = TerminalIdentification.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(TerminalIdentification.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
    ...
    #region TerminalIdentification

    [Fact]
    public void TerminalIdentification_AsToken_ReturnsExpectedResult()
    {
        TerminalIdentificationTestTlv testData = new();
        TerminalIdentification sut = TerminalIdentification.Decode(testData.EncodeValue().AsSpan());
