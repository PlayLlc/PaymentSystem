...
public class IccDynamicNumberTests
{
    ...
    {
        IccDynamicNumberTestTlv testData = new();
        IccDynamicNumber testValue = IccDynamicNumber.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(IccDynamicNumber.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
