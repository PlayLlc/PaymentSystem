...
public class IssuerAuthenticationDataTests
{
    ...
    {
        IssuerAuthenticationDataTestTlv testData = new();
        IssuerAuthenticationData testValue = IssuerAuthenticationData.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(IssuerAuthenticationData.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
