...
public class PositionOfCardVerificationCode3Track2Tests
{
    ...
    {
        PositionOfCardVerificationCode3Track2TestTlv testData = new();
        PositionOfCardVerificationCode3Track2 testValue = PositionOfCardVerificationCode3Track2.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(PositionOfCardVerificationCode3Track2.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
