...
public static class Extensions
{
    ...
    public static void DetachAll(this List<Binding> self)
    {
    ...
    public static void DetachAll(this List<EventToCommandInfo> self)
    {
        self.ForEach((eventToCommandInfo) => eventToCommandInfo.Detach());
