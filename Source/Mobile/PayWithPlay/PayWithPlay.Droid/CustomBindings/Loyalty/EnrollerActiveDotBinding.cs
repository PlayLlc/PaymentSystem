...
namespace PayWithPlay.Droid.CustomBindings.Loyalty
{
    public class EnrollerActiveDotBinding : MvxAndroidTargetBinding<ShapeableView, bool>
    {
        public const string Property = "EnrollerActive";

        public EnrollerActiveDotBinding(ShapeableView target) : base(target)
        {
        }
