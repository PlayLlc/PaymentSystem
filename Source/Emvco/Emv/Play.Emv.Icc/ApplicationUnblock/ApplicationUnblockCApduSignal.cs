...
public class ApplicationUnBlockCApduSignal : CApduSignal
{
    ...
    public ApplicationUnBlockCApduSignal(byte @class, byte instruction, byte parameter1, byte parameter2) : base(@class, instruction, parameter1, parameter2)
    { }

    public ApplicationUnBlockCApduSignal(byte @class, byte instruction, byte parameter1, byte parameter2, uint le) : base(@class, instruction, parameter1,
        parameter2, le)
    { }

    public ApplicationUnBlockCApduSignal(byte @class, byte instruction, byte parameter1, byte parameter2, ReadOnlySpan<byte> data) : base(@class, instruction,
        parameter1, parameter2, data)
    { }

    public ApplicationUnBlockCApduSignal(byte @class, byte instruction, byte parameter1, byte parameter2, ReadOnlySpan<byte> data, uint le) : base(@class,
    ...
    public static ApplicationUnBlockCApduSignal Create(SecureMessaging secureMessaging, CommandTemplate messageAuthenticationCode)
    {
        ...
        return new ApplicationUnBlockCApduSignal(new Class(secureMessaging), Instruction.ApplicationUnblock, 0, 0, messageAuthenticationCode.EncodeValue());
    }
