...
namespace _TempConfiguration.Merchant;
...
public class MerchantInformation
{
    ...
    public MerchantInformation(
        TerminalIdentification terminalIdentification, MerchantNameAndLocation merchantNameAndLocation, MerchantIdentifier merchantIdentifier,
