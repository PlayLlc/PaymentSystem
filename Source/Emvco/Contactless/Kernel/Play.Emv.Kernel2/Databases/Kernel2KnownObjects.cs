...
public sealed record Kernel2KnownObjects : KnownObjects
{
    ...
    static Kernel2KnownObjects()
    {
        _ValueObjectMap = new Dictionary<uint, Kernel2KnownObjects>
        {
            ...
            {TagsToWriteAfterGeneratingApplicationCryptogram.Tag, new(TagsToWriteAfterGeneratingApplicationCryptogram.Tag)},
            {TagsToWriteBeforeGeneratingApplicationCryptogram.Tag, new(TagsToWriteBeforeGeneratingApplicationCryptogram.Tag)},
