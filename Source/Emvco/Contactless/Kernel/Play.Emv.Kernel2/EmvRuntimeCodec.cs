...
public class EmvRuntimeCodec : EmvCodec, IResolveKnownObjectsAtRuntime
{
    ...
    static EmvRuntimeCodec()
    {
        _DecodeHandlers = new Dictionary<Tag, Func<ReadOnlyMemory<byte>, PrimitiveValue>>
        {
            ...
            {TagsToWriteAfterGeneratingApplicationCryptogram.Tag, TagsToWriteAfterGeneratingApplicationCryptogram.Decode},
            {TagsToWriteBeforeGeneratingApplicationCryptogram.Tag, TagsToWriteBeforeGeneratingApplicationCryptogram.Decode},
