...
public record GetDataRequest : QueryPcdRequest
{
    ...
    private GetDataRequest(CApduSignal cApduSignal, MessageTypeId messageTypeId, TransactionSessionId transactionSessionId) : base(cApduSignal, messageTypeId,
        transactionSessionId)
    { }

    private GetDataRequest(TransactionSessionId transactionSessionId, CApduSignal cApduSignal) : base(cApduSignal, MessageTypeId, transactionSessionId)
    { }
    ...
    public static GetDataRequest Create(Tag tag, TransactionSessionId sessionId) => new(GetDataCApduSignal.Create(tag), MessageTypeId, sessionId);
