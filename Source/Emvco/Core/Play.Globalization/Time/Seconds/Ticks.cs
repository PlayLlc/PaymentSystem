...
public readonly record struct Ticks
{
    ...
    public const int _Precision = 10000000;
    ...
    {
        _Value = (long) value * (_Precision / Microseconds._Precision);
    }
    ...
    public TimeSpan AsTimeSpan() => new(_Value * (_Precision - Milliseconds._Precision));
