...
internal class CountryCodeRepository
{
    ...
    private static readonly ImmutableSortedDictionary<Alpha2CountryCode, CountryCodes> _Alpha2CountryMap;
    ...
    static CountryCodeRepository()
    {
        ...
        _Alpha2CountryMap = GetCurrencyCodes().ToImmutableSortedDictionary(a => a.GetAlpha2Code(), b => b);
    }
