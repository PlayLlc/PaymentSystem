...
public class DataRecoveryDataObjectListTests
{
    ...
    public void BerEncoding_DeserializingDataElement_CreatesPrimitiveValue()
    {
        ...
        DataRecoveryDataObjectList testValue = DataRecoveryDataObjectList.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(DataRecoveryDataObjectList.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
