...
public class MerchantCustomDataTests
{
    ...
    {
        MerchantCustomDataTestTlv testData = new();
        MerchantCustomData testValue = MerchantCustomData.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(MerchantCustomData.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
