...
public class DeviceEstimatedTransmissionTimeForRelayResistanceRapduTests
{
    ...
    public void BerEncoding_DeserializingDataElement_CreatesPrimitiveValue()
    {
        ...
        DeviceEstimatedTransmissionTimeForRelayResistanceRapdu testValue =
            DeviceEstimatedTransmissionTimeForRelayResistanceRapdu.Decode(testData.EncodeValue().AsSpan());
    ...
    {
        DeviceEstimatedTransmissionTimeForRelayResistanceRapduTestTlv testData = new();
        DeviceEstimatedTransmissionTimeForRelayResistanceRapdu sut =
            DeviceEstimatedTransmissionTimeForRelayResistanceRapdu.Decode(testData.EncodeValue().AsSpan());
