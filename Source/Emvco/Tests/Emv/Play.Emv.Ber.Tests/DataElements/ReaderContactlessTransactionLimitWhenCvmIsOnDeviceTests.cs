...
public class ReaderContactlessTransactionLimitWhenCvmIsOnDeviceTests
{
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(ReaderContactlessTransactionLimitWhenCvmIsOnDevice.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
