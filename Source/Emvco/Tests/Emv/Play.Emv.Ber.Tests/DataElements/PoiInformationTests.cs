...
public class PoiInformationTests
{
    ...
    {
        PoiInformationTestTlv testData = new();
        PoiInformation testValue = PoiInformation.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(PoiInformation.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
