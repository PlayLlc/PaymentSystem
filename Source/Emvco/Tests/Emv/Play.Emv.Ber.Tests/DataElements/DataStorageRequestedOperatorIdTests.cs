...
public class DataStorageRequestedOperatorIdTests
{
    ...
    {
        DataStorageRequestedOperatorIdTestTlv testData = new();
        DataStorageRequestedOperatorId testValue = DataStorageRequestedOperatorId.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(DataStorageRequestedOperatorId.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
