...
public class IntegratedDataStorageStatusTests
{
    ...
    {
        IntegratedDataStorageStatusTestTlv testData = new();
        IntegratedDataStorageStatus testValue = IntegratedDataStorageStatus.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(IntegratedDataStorageStatus.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
