...
public class TransactionCurrencyExponentTests
{
    ...
    {
        TransactionCurrencyExponentTestTlv testData = new();
        TransactionCurrencyExponent testValue = TransactionCurrencyExponent.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(TransactionCurrencyExponent.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
