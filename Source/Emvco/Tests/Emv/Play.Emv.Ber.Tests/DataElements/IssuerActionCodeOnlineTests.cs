...
public class IssuerActionCodeOnlineTests
{
    ...
    {
        IssuerActionCodeOnlineTestTlv testData = new();
        IssuerActionCodeOnline testValue = IssuerActionCodeOnline.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(IssuerActionCodeOnline.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
