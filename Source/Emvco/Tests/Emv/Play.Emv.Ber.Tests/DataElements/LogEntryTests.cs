...
public class LogEntryTests
{
    ...
    {
        LogEntryTestTlv testData = new();
        LogEntry testValue = LogEntry.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(LogEntry.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
