...
public class DataStorageOperatorDataSetCardTests
{
    ...
    {
        DataStorageOperatorDataSetCardTestTlv testData = new();
        DataStorageOperatorDataSetCard testValue = DataStorageOperatorDataSetCard.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(DataStorageOperatorDataSetCard.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
