...
public class TerminalCountryCodeTests
{
    ...
    {
        TerminalCountryCodeTestTlv testData = new();
        TerminalCountryCode testValue = TerminalCountryCode.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(TerminalCountryCode.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
