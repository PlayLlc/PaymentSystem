...
public class DataStorageApplicationCryptogramTypeTests
{
    ...
    {
        DataStorageApplicationCryptogramTypeTestTlv testData = new();
        DataStorageApplicationCryptogramType testValue = DataStorageApplicationCryptogramType.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(DataStorageApplicationCryptogramType.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
    ...
    [Fact]
    public void DataStorageApplicationCryptogramType_InvokingCryptogramOperator_ReturnsExpectedResult()
    {
        DataStorageApplicationCryptogramTypeTestTlv testData = new();
