...
public class DataStorageOperatorDataSetTerminalTests
{
    ...
    {
        DataStorageOperatorDataSetTerminalTestTlv testData = new();
        DataStorageOperatorDataSetTerminal testValue = DataStorageOperatorDataSetTerminal.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(DataStorageOperatorDataSetTerminal.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
