...
public class DataStorageSummary1Tests
{
    ...
    {
        DataStorageSummary1TestTlv testData = new();
        DataStorageSummary1 testValue = DataStorageSummary1.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(DataStorageSummary1.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
