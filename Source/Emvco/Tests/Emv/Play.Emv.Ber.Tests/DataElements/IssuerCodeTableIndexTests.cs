...
public class IssuerCodeTableIndexTests
{
    ...
    {
        IssuerCodeTableIndexTestTlv testData = new();
        IssuerCodeTableIndex testValue = IssuerCodeTableIndex.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(IssuerCodeTableIndex.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
    ...
    {
        IssuerCodeTableIndexTestTlv testData = new(new byte[]
        {
            77
        });
