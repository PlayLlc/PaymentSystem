...
public class PosEntryModeTests
{
    ...
    {
        PosEntryModeTestTlv testData = new();
        PosEntryMode testValue = PosEntryMode.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(PosEntryMode.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
