...
public class ApplicationVersionNumberCardTests
{
    ...
    {
        ApplicationVersionNumberCardTestTlv testData = new();
        ApplicationVersionNumberCard testValue = ApplicationVersionNumberCard.Decode(testData.EncodeValue().AsSpan());
    ...
    public void BerEncoding_EncodingToTagLengthValue_SerializesExpectedValue()
    {
        ...
        TagLengthValue expectedResult = new(ApplicationVersionNumberCard.Tag, testData.EncodeValue());
        Assert.Equal(testValue, expectedResult);
    }
    ...
    [Fact]
    public void ApplicationVersionNumberCard_CastToUShort_ReturnsExpectedResult()
    {
        ushort input = 12;
