...
public class DataRecoveryDataObjectListTestTlv : TestTlv
{
    ...
    public DataRecoveryDataObjectListTestTlv() : base(_DefaultContentOctets)
    { }

    public DataRecoveryDataObjectListTestTlv(byte[] contentOctets) : base(contentOctets)
    { }

    #endregion

    public override Tag GetTag() => DataRecoveryDataObjectList.Tag;
